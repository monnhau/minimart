...
<div class="content">
			...
			<form method="post" action="{{route('admin.valueOption.updateMauNen')}}">	
				{{csrf_field()}}		
				<div class="item_data">
					<p>Chọn màu:</p>
					...
					@else
					<input style="width: 20%;height: 40px;" type="color" value="{{$MauNenProvider->value_char}}" name="mau_nen_demo" class="txt_field_half">
					@endif
				</div>
