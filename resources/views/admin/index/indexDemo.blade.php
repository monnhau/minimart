...
@php
$mauNenDemo = App\ValueOption::getItemByName("mau_nen_demo");
@endphp
@if($mauNenDemo == null)
<body >
@else
<body style="background: {{$mauNenDemo->value_char}} !important">
@endif
    ...
    <div class="verify_color" style="height: 53px;background: #333;color: #fff;margin-bottom: 10px;text-align: center;line-height: 50px;">
		 ...
		 <a style="background: green;padding: 5px 15px;margin-right: 5px;" href="{{route('admin.valueOption.updateMauNenReal')}}">OK</a>
		 <a style="background: red;padding: 5px 15px;margin-right: 5px;" href="{{route('admin.valueOption.updateMauNen')}}">Hủy</a>
    </div>
	<div class="container">
		<div class="header">
