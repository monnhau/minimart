...
<div class="content">
			...
			<form action="{{route('admin.slide.add')}}" method="post">
                {{csrf_field()}}
				<div class="item_data">
					<p>Lời mô tả ảnh:</p>
					<input type="text" name="desc_text" class="txt_field" value="{{ old('desc_text') }}">
				</div>
			
				<div class="item_data">
					<p>Lời chi tiết ảnh:</p>
					<textarea name="detail_text" rows="3" class="txt_field area_field">{{ old('detail_text') }}</textarea> 
				</div>
